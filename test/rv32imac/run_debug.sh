...
# === Configuration ===
SPIKE_BIN="../../tools/spike/install/bin/spike"
OPENOCD_BIN="../../tools/openocd/install/bin/openocd"
GDB_BIN="../../tools/toolchains/rv32imac-ilp32/install/bin/riscv32-unknown-elf-gdb"
...
"$SPIKE_BIN" -m64 --isa=rv32i_zicsr_zifencei --rbb-port="$RBB_PORT" --halted "$ELF_FILE" \
    &> /dev/null &
SPIKE_PID=$!
sleep 1
